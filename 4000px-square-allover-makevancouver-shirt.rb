...
makevancouver_width =  4000
makevancouver_length = 4000
output_png =
  ChunkyPNG::Image.new(
    makevancouver_width, makevancouver_length,
    ChunkyPNG::Color::TRANSPARENT)
num_pixels = makevancouver_width * makevancouver_length
...
loop do
  ...
  if i >= num_pixels || y >= makevancouver_length
    break
  end
  ...
  if x == makevancouver_width
    ...
    interim_filename = sprintf(
      "hatched-makevancouver-%4.4d-%2.2d-%2.2d-%2.2d-%2.2d-interim-200x200-oily-out-row-%4.4d.png", \
...
t = Time.now
filename = sprintf("hatched-makevancouver-%4.4d-%2.2d-%2.2d-%2.2d-%2.2d-oily-200x200-out.png",
  t.year, t.month, t.day,  t.hour, t.min)
